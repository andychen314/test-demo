...
public class MessageAdapterHandler {
    ...
    public void add(String queueName, String exchangeName, EventProcesser processor, ICodecFactory codecFactory) {
    ...
    protected static class EventProcessorWrap {
        ...
        protected EventProcessorWrap(ICodecFactory codecFactory,
                                     EventProcesser eep) {
